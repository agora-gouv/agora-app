      ...
      final consultation = DynamicConsultation(
        ...
        history: [
          ConsultationHistoryStep(
            ...
            status: ConsultationHistoryStepStatus.incoming,
          ...
          ConsultationHistoryStep(
            updateId: 'updateId',
            type: ConsultationHistoryStepType.update,
            status: ConsultationHistoryStepStatus.current,
            title: 'Réponse du gouvernement',
            date: DateTime(2024, 4, 30, 23),
            actionText: null,
          ),
          ConsultationHistoryStep(
            updateId: 'updateId',
            ...
            title: 'Synthèse des données',
            date: DateTime(2024, 4, 21, 23),
            actionText: 'Consulter la synthèse',
          ),
          ConsultationHistoryStep(
            updateId: 'updateId',
            type: ConsultationHistoryStepType.results,
            status: ConsultationHistoryStepStatus.done,
            title: 'Fin de la consultation',
            date: DateTime(2024, 3, 15, 23),
