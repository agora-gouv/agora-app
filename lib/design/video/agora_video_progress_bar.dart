...
// Forked from CupertinoVideoProgressBar: https://github.com/fluttercommunity/chewie/blob/master/lib/src/cupertino/cupertino_progress_bar.dart
class AgoraVideoProgressBar extends StatefulWidget {
  AgoraVideoProgressBar(
    this.controller, {
    AgoraVideoProgressColors? colors,
    this.onDragEnd,
    this.onDragStart,
    this.onDragUpdate,
    super.key,
  ...
  }) : colors = colors ?? AgoraVideoProgressColors();

  final VideoPlayerController controller;
  final AgoraVideoProgressColors colors;
  ...
  _AgoraVideoProgressBarState createState() {
    return _AgoraVideoProgressBarState();
  }
}

class _AgoraVideoProgressBarState extends State<AgoraVideoProgressBar> {
  void listener() {
    if (!mounted) return;
    setState(() {});
  }
