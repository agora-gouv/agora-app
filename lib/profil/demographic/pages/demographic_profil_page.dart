        ...
        child: BlocBuilder<DemographicInformationBloc, DemographicInformationState>(
          builder: (context, state) {
            return AgoraSecondaryStyleView(
              ...
              title: _Title(),
              buttonLabel: state is GetDemographicInformationSuccessState ? GenericStrings.modify : null,
              buttonSemanticLabel: "Modifier mes informations",
              onTapButton: state is GetDemographicInformationSuccessState
                  ? () {
                      Navigator.pushNamed(
                        context,
